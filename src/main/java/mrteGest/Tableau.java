    ...
    public Tableau(Gestion telleGestion, Vector telleEnTete, Vector telleRangee, boolean selection) {
        ...
        TableModel dataModel = new AbstractTableModel() {
            ...
            public int getRowCount() {
                return lesRangees.size();
            }

            public Object getValueAt(int row, int col) {
                return ((Vector) lesRangees.elementAt(row)).elementAt(col);
            }

            // The default implementations of these methods in
            // AbstractTableModel would work, but we can refine them.
            public String getColumnName(int column) {
                return (String) lEnTete.elementAt(column);
            }
        ...
        DefaultTableCellRenderer inscritColumnRenderer = new DefaultTableCellRenderer() {
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean isFocused, int row, int column) {
                ...
                if (table.getColumnName(column).equals("Inscrit") || table.getColumnName(column).equals("Nouveau")
                        || table.getColumnName(column).equals("Assurance")) {
            ...
            rowSM.addListSelectionListener(new ListSelectionListener() {
                public void valueChanged(ListSelectionEvent e) {
                    ...
                    if (lsm.isSelectionEmpty()) {
                        ...
                        laGestion.tMail.setText((String) tableView.getValueAt(selectedRow, 16));
                        laGestion.tAdresse2.setText((String) tableView.getValueAt(selectedRow, 17));
